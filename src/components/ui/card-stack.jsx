    ...
    (<div className="relative w-full h-[430px] sm:h-[350px] mt-10">
      {cards.map((card, index) => {
        return (
          (<motion.div
            key={index}
            className="absolute bg-card px-5 sm:px-10  h-full flex flex-col justify-center border-[3px] border-[#2C2F35] rounded-3xl"
            style={{
            ...
            <div>
              <p className="text-[16px] md:text-[20px] leading-relaxed mb-5">
                "{card.para}"
              </p>
            </div>
