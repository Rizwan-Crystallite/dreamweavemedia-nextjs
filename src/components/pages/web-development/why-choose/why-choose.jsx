                        ...
                        <div>
                            <BlurFade delay={0.5 * 2} inView>
                                <div className="xl:max-w-[600px] grid grid-cols-1 gap-y-4 text-[16px] leading-relaxed mb-5">
                                    ...
                                    <p>
                                        At Dream Weave Media, We don't just build websites; we craft digital experiences that leave a lasting impression. As a leading web development agency in USA, We have successfully designed and developed over 300 websites, catering to diverse industries both locally and globally.
                                    ...
                                    <p>
                                        Our web team boasts expertise in a range of languages and frameworks, including PHP, Java, Python, JavaScript, C#, C++, Ruby, Codeigniter, and Laravel.
                                    </p>
                                </div>
                            </BlurFade>
