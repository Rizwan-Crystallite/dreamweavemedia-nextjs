...
import stacks from "media/web-development/stacks.webp"
// Framer
            ...
            <div>
              <BlurFade delay={0.5 * 2} inView>
                <div className="xl:max-w-[600px] grid grid-cols-1 gap-y-4 text-[16px] leading-relaxed mb-5">
                  <p>
                    Stand out online with a top-notch web development team. At
                    Dream Weave Media, we don’t just make websites – we build
                    digital experiences that stick with people. We’ve built over
                    300 sites for businesses large and small, both locally and
                    worldwide. Our mix of front-end creatives and back-end
                    experts is at the heart of our success. We love taking on
                    tough projects and thinking differently.
                  </p>
                  <p>
                    Our team works with many languages and frameworks like PHP,
                    Java, Python, JavaScript, C#, C++, Ruby, Codeigniter, and
                    Laravel.
                  </p>
                </div>
              </BlurFade>
