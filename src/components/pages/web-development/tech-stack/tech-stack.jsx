                ...
                <div className="container">
                    <BlurFade delay={0.5} inView>
                        <div className="relative z-10">
                            ...
                            <h3 className="text-[40px] sm:text-[45px] lg:text-[50px] xl:text-[60px] leading-tight font-bold md:absolute md:top-0 md:bottom-0 md:h-full md:flex md:items-center md:right-0 md:left-0 mb-5 md:mb-0">
                                <span>
                                    The Tech <span className="text-primary">behind</span> our <span className="text-primary">products</span>!
                                </span>
                            </h3>
                        </div>
                    </BlurFade>
                    <BlurFade delay={0.5 * 2} inView>
                        <p className="text-[16px] sm:text-[20px] lg:text-[24px] leading-relaxed max-w-[1000px] font-medium">
                            Our team of developers has a range of experience in cutting-edge technologies.  This allows us to create a Dream Weave Media made tech stack that will best support your project’s needs.
                        </p>
                    </BlurFade>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 gap-y-10 items-center">
                        <div>
                            <BlurFade delay={0.5} inView>
                                <Image src={front} alt="Dream Weave Media" className="md:max-w-[90%] md:mx-auto" />
                            </BlurFade>
                        </div>
                        <div>
                            <BlurFade delay={0.5 * 2} inView>
                                <Image src={back} alt="Dream Weave Media" className="md:max-w-[90%] md:mx-auto" />
                            </BlurFade>
                        </div>
                    </div>
                </div>
