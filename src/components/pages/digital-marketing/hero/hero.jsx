          ...
          <div className="max-w-[1000px]">
            <BlurFade delay={0.5} inView>
              <h1 className="text-[28px] sm:text-[45px] md:text-[62px] lg:text-[70px] font-bold leading-snug sm:leading-tight mb-3">
                <span className="text-primary">Struggling</span> to grow online?
                Our <span className="text-primary">digital marketing</span>{" "}
                services can help.
              </h1>
            </BlurFade>
            <BlurFade delay={0.5 * 2} inView>
              <p className="text-[16px] leading-relaxed mb-5">
                Marketing shouldn’t be confusing. At Dream Weave Media, we
                create strategies that drive real growth, more leads, more
                sales, and more success. No fake promises, just results.
              </p>
            </BlurFade>
          ...
          <ul className="xl:absolute xl:top-0 xl:right-2 flex items-center mt-8 xl:mt-0 xl:grid xl:grid-cols-1 gap-4 z-[2]">
            {socials.map(([icon, link], i) => (
              ...
              >
                <a
                  href={link}
                  className="w-[50px] h-[50px] border-2 border-white bg-[#093943] inline-flex items-center justify-center rounded-full [&:hover_img]:brightness-0 [&:hover_img]:invert hover:bg-secondary"
                >
