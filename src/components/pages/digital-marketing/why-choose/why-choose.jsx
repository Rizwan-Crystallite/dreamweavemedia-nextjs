...
import stacks from "media/digital-marketing/stacks.webp"
// Framer
              ...
              <BlurFade delay={0.5 * 2} inView>
                <div className="xl:max-w-[600px] grid grid-cols-1 gap-y-4 text-[16px] leading-relaxed mb-5">
                  <p className="text-[18px] xl:text-[20px] leading-normal font-semibold">
                    Our Impact: Driving Success in Numbers
                  </p>
                  <p>
                    At Dream Weave Media, our commitment to excellence is
                    reflected in the impressive milestones we’ve achieved.
