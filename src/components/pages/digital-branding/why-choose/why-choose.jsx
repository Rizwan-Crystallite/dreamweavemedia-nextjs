...
import stacks from "media/digital-branding/stacks.webp"
// Framer
                    ...
                    <BlurFade delay={0.5} inView>
                        <div className="relative z-10">
                            ...
                            <h3 className="text-[40px] sm:text-[50px] lg:text-[50px] xl:text-[60px] leading-tight font-bold md:absolute md:top-0 md:bottom-0 md:h-full md:flex md:items-center md:right-0 md:left-0">
                                <span>
                                    Digital <span className="text-primary">Branding</span> Service!
                                </span>
                            </h3>
                        </div>
                    </BlurFade>
                        ...
                        <div>
                            <BlurFade delay={0.5 * 2} inView>
                                <div className="xl:max-w-[600px] grid grid-cols-1 gap-y-4 text-[16px] leading-relaxed mb-5">
                                    ...
                                    A Strong Brand Does More Than Look Good, It Creates Trust.
                                    </p>
                                    <p>
                                    As with other aspects of branding, digital branding is all about the worth of your business, what motivates and frames what you do, and then conveying those values to your website visitors. We create brand identities that communicate with your audience, tell your story, and set you apart from competitors.
                                    </p>
                                </div>
                            </BlurFade>
                            <BlurFade delay={0.5 * 3} inView>
                                <ul className="text-[14px] leading-relaxed grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-5">
                                    {
                                        ["750+ businesses rebranded – Giving brands a fresh, modern identity.", "60%+ increase in brand engagement – Helping businesses connect better.", "99% positive brand perception – Building trust with smart branding.", "40+ startups launched with our branding – Setting them up for success."].map((e, i) => (
